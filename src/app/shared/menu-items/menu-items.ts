...
const MENUSETTINGS = [
    ...
    { state: '', name: 'Configuración de pago', type: permissions.EDIT_ENTERPRISE_CONTROL, icon: 'credit_card_gear', children: [
...
const MENUMANAGEMENT = [
    ...
    { state: '', name: 'Stock', type: '', icon: 'assignment', children: [
        ...
        { state: 'product/add-product', name: 'Edición de producto', type: permissions.EDIT_PRODUCT_CONTROL, icon: '' },
        { state: 'product/category', name: 'Categorías', type: '', icon: '' }
    ] },
    { state: '', name: 'Proveedores', type: permissions.EDIT_PROVIDER_CONTROL, icon: 'group', children: [
    ...
    { state: '', name: 'Depósito', type: '', icon: 'storage', children: [
        ...
        { state: 'storage/storage-edit', name: 'Edición de depósitos', type: permissions.EDIT_ENTERPRISE_CONTROL, icon: '' }
    ] }
];
